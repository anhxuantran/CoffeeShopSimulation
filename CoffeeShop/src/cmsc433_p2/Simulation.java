...
public class Simulation {
	...
	public static HashMap<Customer, Boolean> custMap = new HashMap<Customer, Boolean>();
	...
	public static List<SimulationEvent> runSimulation(int numCustomers,
		 ...
		 */
		LinkedList<FoodOrder> orders = new LinkedList<FoodOrder>();
		...
		for (int i = 0; i < numCooks; i++) {
			cooks[i] = new Thread(new Cook("Cook " + i, orders, machines));
		}
